...
class LlamaMLP(nn.Module):
    ...
    def forward(self, x):
        ...
        down_proj = self.mlp_out(down_proj)
        return down_proj
...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None):
        ...
        # self.P_weight = nn.Parameter(1e-1*torch.randn(self.hidden_size, self.hidden_size))
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.embed_tokens_id = nn.Identity()
    ...
    def forward(
        ...
        **kwargs
        ...
        inputs_embeds = self.embed_tokens_id(inputs_embeds)
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.fv_projections = nn.ModuleList()
        for i in range(10):
            self.fv_projections.append(nn.Linear(dim, dim))
            self.fv_projections[i].apply(init_diagonal)
